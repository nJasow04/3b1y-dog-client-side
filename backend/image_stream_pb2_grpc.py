...
class ImageStreamStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendImage = channel.unary_unary(
                '/imagestream.ImageStream/SendImage',
...
def add_ImageStreamServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'imagestream.ImageStream', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('imagestream.ImageStream', rpc_method_handlers)
